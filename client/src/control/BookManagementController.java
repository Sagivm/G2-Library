 ...
 */
  ...
  */
 @FXML
 public ListView < String > addBookAuthorsList;
  ...
  */
 @FXML
 public ListView < String > addBookLanguageList;

 /**
  * List view of the added book subjects
  */
 @FXML
 public ListView < String > addBookSubjectsList;
...
public void SendDeleteMessage(PropertyBook selectedItem)
{
 ...
 /**
  * This method create a new book in the DB.
  * @param event The event when button pressed.
  * @throws IOException IO exception.
  */
 @FXML
 public void submitButtonPressed(ActionEvent event) throws IOException{    
 	   String TitleBook = new String();
 	   TitleBook = addBookTitle.getText();
 	   System.out.println(TitleBook);

 	   ObservableList < String > Authors = addBookAuthorsList.getSelectionModel().getSelectedItems();
 	   String authorsId = new String();
 	   for (int i = 0; i < Authors.size(); i++)
 	    authorsId += Authors.get(i).substring(Authors.get(i).indexOf("(") + 1, Authors.get(i).indexOf(")")) + "^";
 	 
 	   if(AddBook.testMode==true){
 		 authorsId=addBookAuthorsList.getItems().get(0);
 	  }
 	  ...
 	  if(AddBook.testMode==true){
 		 SubjectsList=addBookSubjectsList.getItems().get(0);
  	  }
 	   
 	 System.out.println(SubjectsList);
 	 
 	   String tableOfContent = new String();
 	   tableOfContent = addBookTableOfContent.getText();
		...
		clientCtrl.clientConnectionController.sendToServer(message6);
